...
def get_prognoses(by_age=True):
    ...
    if not by_age:
        ...
        prognoses = dict(
            ...
            death_probs  = np.array([0.00002, 0.00006, 0.00030, 0.00050, 0.00150, 0.00300, 0.00500, 0.05100, 0.09300]), # Overall probability of dying (https://www.imperial.ac.uk/media/imperial-college/medicine/sph/ide/gida-fellowships/Imperial-College-COVID19-NPI-modelling-16-03-2020.pdf)
        )
